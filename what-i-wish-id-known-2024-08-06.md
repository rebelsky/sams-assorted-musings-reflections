...
blurb: I don't really remember that far back.
version: 0.1
released: 2024-08-06
current: 2024-08-05
---
A few years ago, someone told me that they had begun work on a document that they called "What I wish I'd known when I started at Grinnell". Such a document seems useful. If I recall correctly---and I rarely do---they had a very different idea about what one might know: Their document discussed places to shop and such, things I consider easy to find out.

Rather, I would have hoped to have something that explained how the College works (or fails to work). As one person noted, "_This place is bananas_" [1]. That is, Grinnell does not necessarily behave like other institutions of higher education.

I've been at Grinnell too long [2] to recall all the things that surprised me about the institution. Grinnell's also changed a lot since then. Nonetheless, it may be useful to reflect on some things that newcomers (mostly new faculty, but also some new staff) would benefit from hearing.

Some newcomers have also told me that my musings serve as one introduction to the institution. Isn't that terrifying?

In any case, the following represents my attempt to cover some of the things I would have liked to know if I was just starting at Grinnell. Feel free to suggest others [3], and I'll either add them to this document or put together a sequel. They appear in no particular order. They may present a somewhat negative outlook about the College, but that's because you need to be warned about the problematic things rather than the great things.
...
That's probably enough for now. Maybe I'll come up with more later. Or perhaps my readers will.
...
[5] I have to include that last part because the administration keeps telling us that salaries are our biggest expense.
...
[9] I deal with the inconsistency by observing that the _Handbook_ by itself is not a contract, but it becomes contractual when included by reference in a signed contract.

[10] Can you tell that I'm bitter about this issue? I consider it one of Grinnell's most significant failings. I regularly hear from prospective faculty who are frustrated that they couldn't find out about important issues because they were hidden on GrinCo.

[11] Faculty tend to use "Department" to mean "Academic Department". Non-faculty use "Department" to mean things like "Admissions" or "Student Affairs". That can create confusion when, say, a policy refers to a Department.

[12] Remember that one? "Instructional Support Committee".

[14] Officially, the Donald and Winifred Wilson Center for Innovation & Leadership.

[15] Payment for summer workshops is complicated. Staff and faculty on twelve-month contracts don't get paid for participating in summer workshops, even though such participation generally requires additional work.
