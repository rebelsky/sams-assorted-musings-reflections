...
_Topics/tags: [Registration](index-registration), [Grinnell](index-grinnell), assorted data, rambly, long, end-notable_
...
Education_ [14] was over-enrolled by three students.  Now it's over-enrolled
by two.  HIS-277, _China's Rise_, was over-enrolled by ten students
(thirty-five enrolled with a cap of twenty-five).  Now it's
over-enrolled by only two.  I wonder what happened to the other eight
students.  That's a serious comment; I'm still not sure how many
department decide who to cut or to move.  HIS-330, _Pol of Food/Early-Mod
England_, was over-enrolled by seven.  Students do seem to like courses
targeted at food.  Now it's right at capacity.  It looks like those
students shifted to other 300-level seminars.  

On a side note, I'm interested by the choice to include "of" in the
...
early 1960's and the start of the Mod movement in England.  With that
...
to get a better understanding of the time [15].

HUM-195, _ST: Soc Impact Documenry Film_, had fifty students enrolled
...
it's cross-listed as ANT-395 [18].  I don't think it's worth my effort
to see what 200-level courses count toward the Linguistics concentration,
but I do wonder why they droppee dropped the article in the prerequisite
description.  In any case, it appears that they cut three students
from that course.
...
do math at 8:00 a.m. [19]?  Section 2 was over-enrolled by one student
...
about that over-enrollement, since it's an intensive proof-writing
...
courses over-enroll [20].  I expect a few students switched to MAT-316.

MAT-322, _Algebraic Graph Theory_, had nineteen students enrolled and
a cap of twelve.  Now it has "only" sixteen students enrolled [21].  From
...
the course?"  But another part of me reminds that part that we have course
caps for a reason.  Speaking of MAT-395: I'm not sure why it's not listed
as STA-395.  Oh, wait.  It is.  Cross listing between Mathematics and
Statistics is new to me.
...
other adminsitrators realize what a burden it is to have to deal with
...
Fall of 1997, we had about seven mathematicians [22,25].  As best
I can tell, we still have seven [26].  Grinnell has grown a lot in
the past twenty-some-odd years.  And the Sciences have grown even
more, at least as a percentage of majors [27].  I'd hope that's a
...
past decade [28].  However, counting additions in Statistics against 
Mathematics is like counting additions in Arabic against French [30].

Wow.  I'm digressing a lot.  Back to the main musing.

Music is hard to analyze because there are so many kinds of music
courses.  Let's start with the music lessons [31].  MUS-120-08,
...
week and MUS-221 meets for sixty minutes each week [32].  MUS-320,
...
the practica faculty get paid per set of lessons [33] .  Where do
...
genefits to someone who is teaching more than twenty lessons.
...
gone.  In it's palce are MUS-120-14, _Perf: Piano_, with fifty one
students [34], and MUS-120-20, with eleven students.  Since there
...
students, MUS-120-23, _Perf: Voice_, with no students [35], and
...
Horn, Clarinet, Cornetto [36], Double Bass, Flute, French Horn,
...
majors) who have interest in getting lessons in another instrument
...
enrollments.  I see about 329 in MUS-120 [37], forty-one (41) in
...
MUS-201, _Digital Music-Making_ [38], was enrolled at nearly twice
...
gets an annual course release [39].
...
in a course with a cap of siteen.  It's another of those half-semester,
Monday-evening, one-credit courses that seem to be popular with students.
It appears that they allowed all the students to remain in that coruse.
...
* PHE-100-13, _Golf_, had fifteen enrolled with a cap of ten.  It now has
  thirteen enrolled.
* PHE-100-19A, _Rock Climing_, had seventeen enrolled with a cap of seven.
...
* PHE-100-41, _Beginning Weight Lifting_, had thirty-one enrolled with
  ...
  had anything to do with that.  It's down to twenty-nine.  Is there really
...
member and we had the wonderful chaos of Harris Registration [40],
PHI-111 was often the first course to fill.

Section 3 of PHY-132, _General Physics II w/lab_ was over-enrolled by
nine students.  But section 1 had eleven open slots [41] and section 2 had
...
or is that another of Wayne Moyer's courses?  iSpeaking of over-enrolled
...
in its early days [43]?  It's now down to fourteen.  POL-295-02, _ST: Political
...
not sure.  I should do a study of caps on special topics courses [44].  In
...
SOC-265, _Sociology of Healty & Illness_, had thirty-seven enrolled
...
STA-209, _Applied Statistics_, instead [45].  Why is it "SST" rather
...
pedagogy that I was imposing on them [46].  At the same time, some
of them struggled to add fractions.

In any case, STA-209 is a popular class. We used to offer on section
...
We appear to have two multi-year visitors [47].  Everyone is teaching
this spring, and it doesn't cover the demand [48].
...
Post-Bodies", and "Analog Photography" [49].

Biological Chemistry has "HDX and LCMS of Peptides" [50], "Syn
Teixobactin Analogue", "Bio Eval of LUG Deriv", "HDX Mass Spec of
MTHFR" [51], "Char LNC-RNS in C elegan" [52], "LNC-RNA Express C
...
[53], "Fungal Litter Ecotypes", "Phage & Antibiotic Res", "Branched
...
Economics has "Adv Political Economy" and "Chrismas Lights & Creme".

Education has "Rural Education", "Educ and Foster Youth", "Implement
Law Teach Union" [58], and "NGO Spd Edu Ini for Kaya".
...
Latin-American Stuies has "Immigration Sentiment" and "Social Justice in
HS SPN".
...
Political Science has "Qualitative Data Anlaysis" and "US, PRC, & Int'l 
Regimes".
...
Neoliberalism", "Behond Baldwin & Julien", "Language of Biophilia", and
...
and Music, perhaps because there are some interesting things happening
in enrollments in each department.

---

Postscript: Not only is this musing one of the longest I've written
in terms of wordcount [60] and number of endnotes [61], it also
seems to have taken me much longer than any prior musing.  I'm not
sure exactly how much time it took, since I wrote it over multiple
sessions, but I expect that it's over eight hours [62].  I don't think
I'll regularly have the time to write this much for a single musing.
...
have made a difference on staffing; if I recall correctly, they've
helped us with Linguistics and CS.  If they also help with Studio
Art, or Russian Cooking [63], or Mathematics, or Statistics, or
Latinx literature, they are probably worth it.

If you can't help teach these courses [64], but have some spare cash,
you could donate to help one of these endeavors.  At the high end,
you could consider endowing a professorship in one of the aforementioned
departments [65].  Somewhere in the middle, you might donate to name
the Global Kitchen, unless it's named already.  I'd suggest naming it
after the Mohans, but there are certainly other opportunities.

Well, enough of that digression.  I hope you enjoyed some part of this
musings as you will be unlikely to see another of its like again, at
least in semesters when I'm not on leave [66].
...
[14] It's also listed as EDU-210.  I'm not sure why I didn't cover it there.

[15] Or at least you would if I were teaching the course [16].

[16] Which suggests, among other things, that it's probably a good thing
that I'm not teaching the course.

[17] Andrew Sherburne '01 is teaching the course.  Andrew was a dual
...
opened a second one, or at least is helping manage a new one.  Now
there are two open slots.  That seems strange.  Since it's a short
course, I would have bribed him to offer a second section.

[18] Did you know that there was once a time in which you could not
...
[19] I know the answer to that: Henry Walker.

[20] I suppose some might suggest that we could tell students to
choose another major.  However, that does not strike me as a good
idea.  It may also be that there are some non-matjoers taking
...
[21] And yes, it still has a cap of twelve.

[22] Arnie Adelberg, Marc Chamberland [23], Gene Hermann, Chuck
Jepsen, Charles Jones [24], Emily Moore, and Royce Wolfe. Emily was
...
[23] Marc started the same time I did, so it's not quite accurate
to say that he was there "when I started", but it's close enough.

[24] I've now been at Grinnell long enough that I could no longer
...
[25] We also had two other folks with Ph.D.'s in Mathematics: Henry Walker,
who had moved to teaching only CS as part of the deal that got me hired, and 
Pam Ferguson, who was president of Grinnell.  Coincidentally, Henry and Pam
had taught Calculus together.  I still remember Henry telling me that since
he and Pam did different kinds of mathematics, they approached the course
very differently.  How's that for interdisciplinarity?

[26] Jeff Blanchard, Marc Chamberland, Chris French, Joe Mileti,
Jen Paulhus, Karen Shuman, and Royce Wolfe.

[27] I'm not saying that's a good thing; I'm just reporting on the data.

[28] When I started, we had Tom Moore in a shared position with
Emily Moore, who taught only Math [29] and Tom taught some Calculus
...
[29] And CS, before I arrived at Grinnell.

[30] Grinnell has a department of French and Arabic.

[31] Also called "Performance" courses.

[32] If I recall correctly, MUS-220 is covered under the "everyone
student gets a series of lessons each semester" policy, but MUS-221
requires an extra fee.

[33] Plus, I would hope, some base amount.

[34] That certainly sounds like a full-time job, if not more.

[35] Don't ask me to explain that.  I had thought it was a shorthand
...
[36] There's also an "Advanced Cornetta", but I assume that's a typo.

[37] I counted by hand, rather than using a spreadsheet, so I may be off
a bit.

[38] That's an unnecessary hyphen.

[39] Up until a few years ago, most Department chairs got a full-course
...
[40] While I know that our current systems is fairer, I miss Harris
registration.  I felt like I learned something looking at where lines
were forming and I appreciated the chance to talk to students face
to face.  Plus, since CS was not all that popular, I could wander
around, hand students candy, and then ask them if they'd been taught
not to accept candy from strangers.

[41] You may not be surprised to hear that section 1 was at t8:00 a.m.
Monday, Wednesday, Friday.

[42] The answer.

[43] Did I include that in my list of courses I'd like to take this spring?
If not, I should have.

[44] My initially empty list of potential musings for 2020 is growing
rapidly.

[45] More on that course in a bit.

[46] Workshop-style statistics was an obvious innovation.  R was a less
obvious one, particularly since R did not have a nice UI at the time.

[47] I write "appear to" because I don't know the status of our visitors.

[48] I was going to write "the need", but it's not clear that any
particular student explicity needs either course.  On the other
hand, I would argue that at this time, every liberally educated
student needs some statistical literacy.

[49] That reminds me: We have analog photography supplies in the basement
...
[50] Chemistry is not my forte.  LMS stands for Learning Management System.
...
[51] I don't think you want to hear how I read "MTHFR".

[52] Arguably, that should be _C. elegans_.

[53] I did not know that slugs contributed to cancer.  I'll need to keep more
salt around.

[54] I don't think that's the kind of molecular computation that my 
former CS colleague, Titus Klinge, studied.

[55] I definitely have no clue on this one.  But then I have little clue
on most of the Chemistry titles and abbreviations [56].  

[56] Some might argue that I have little clue on most topics.

[57] Heinz.

[58] I can't parse that one, either, which suggests that a prior endnote
may be more accurate than I thought.

[59] I like "Brrrs", which makes me think of shivering, in the title of
a research project on the climate movement.  And yes, I understand that
it stands for "barriers".

[60] Over 8000 words, at last count.

[61] That should be obvious from this number.

[62] I'm also counting the time it took to read through and organize data.

[63] That would probably require that we open another evening class time.

[64] Or the College won't allow the appropriate department to hire you.

[65] Or, I suppose, in any department.

[66] Since I'm on leave for spring 2020, I may still be able do one for 
fall 2020.  We'll see how things are going then and how much homework
Ralph and Justin are giving me.

---

*Version 0.3 of 2020-01-01.*
