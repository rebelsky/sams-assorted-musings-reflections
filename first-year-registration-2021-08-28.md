...
blurb: A bit rougher than anyone would like.
version: 0.1
released: 2021-08-28
current: 
---
...
notion of what the demand is going to be on courses.  And you can
...
courses in their four years of college.  So we have to have students
...
Which leads us to the registration process for first-years.
...
situation [5].  Worse yet, there were almost no slots available for
...
mentor, so the students and I will survive and perhaps even thrive.
...
_We have a larger-than-normal entering class._  Many students deferred
admission because of the pandemic.  I expect that it didn't seem quite
fair to make it that much harder for students applying this year to gain
admission.  So we have a particularly large entering class.  You can
tell that in part because most sections of Tutorial are at 14 students
rather than twelve [8] and because we've once again ended up converting
doubles to triples in the dorms [9].
...
awesome ACM [10] Newberry Library Chicago program was canceled.  I also 
...
tenured faculty member resigned in the middle of summer.  There are
likely others who I do not now about.
...
returned to the faculty in mid summer.  And while we have an
absolutely amazing set of folks in the Registrar's office [11], they
had been completely overworked during the pandemic.  Or maybe they
noticed and others ignored their worries.

Of course, the Open [12] Curriculum makes predictive analytics hard.
Changes in the student body and in the world can have significant
...
parents often feel otherwise [14].  I have the most knowledge about
my own department, Computer Science.  When I started at Grinnell,
the vast majority of CS majors took their first CS course in their
...
CSC-151 in their first year_ [15].  I suppose that we might eventually
...
first semester.  In fact, when I teach Tutorial (and therefore
advise students), I often make students write essays defending
...
also note that many faculty (and, fortunately, many students [16])
...
insufficient number of slots.  But they did have an impact on students
and their parents feeling that there were insufficiently many slots
in the courses they wanted to take.
...
At current staffing levels, counting both tenure-line and term faculty [17],
...
first semester [18].  In some years, such as this year, all of the
...
we have to hold firm in spite of the dozens of emails we get asking
...
students [21].  And we also have room for the first-years who have
...
It may matter that students already know that demand for CSC-151
is comparatively high.  Some students might not even try if they
worry that they are going to get cut [23].  Does it also make a
...
disciplines?  Again, I'm not sure.  If we had more staffing [24],
we might discuss offering a course that emphasizes practical
programming and how it would fit into the major [26].
...
**_Postscript_**: We did allow an extra twelve or so students into
...
[8] I believe that's even after we added at least two extra sections.

[9] That could also be because there was less demand for off-campus housing.

[10] Associated Colleges of the Midwest, not Association of Computing
Machinery.

[11] I seem to recall that we are now supposed to refer to the Registrar's
Office as "EASE".

[12] Individually Advised

[14] As a parent of one college-aged child and two college graduates,
I understand and empathize with the frustration of not having your
child get the courses they want.  But they adapt.

[15] I'm pretty sure that every undeclared student who has pre-enrolled in 
CSC-151 in their third semester has gotten into CSC-151.

[16] At least after they discuss the idea with their faculty member.

[17] If I did not count the term faculty, we would not be able to support
the number of majors we have and would probably be down to three or four
sections of CSC-151.

[18] I realize that there are some counter-arguments.  For example,
some students may rely on CS in their first semester to get a
winter-break internship [19].  Personally, I worry that students
...
[20], perhaps we could try offering more intro sections in the fall.

[19] Those are rare.

[20] Hint, hint.

[21] Well, sometimes not the seniors.

[22] "It may have been my most time consuming course, and my instructor
made far too many 'jokes', but CS expanded my mind in amazing new ways.
You should take it, too."

[23] As I noted above, I worry about the effects of those from groups
who are underrepresented in the field.

[24] Yes, I realize that I'm a bit of a broken record [25].

[25] I was going to explain vinyl records and turntables, but then I
realized that they are hip again and students probably get the idea of
broken records.

[26] That seems like a good topic for a future essay.
