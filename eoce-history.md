...
evaluation forms.  Well, at least Math/CS had its own.  If I recall
correctly, the form was mostly developmental, asking students about
strengths and weaknesses of the course.  It was also almost exclusively
qualitative, with only one quantitative question: "How many hours
per week did you spend on this class?"

But things changed.  Two committees on campus felt like they needed
more information as they assessed faculty.  The Personnel Committee
felt like in needed more "independent" information on faculty.  And the
Faculty Budget Committee had been tasked with assigning each faculty
[a merit score](index-salary-reviews).  But how do you assign a merit
score that should be primarily based on teaching without a consistent
way to assess teaching?  Those challenges led those two committees to
suggest a common end-of-course evaluation.  Executive Council led
the way.

A proposal was presented at the March 15, 1999, faculty meeting.  That
proposal to conduct a preliminary test of a new, common, end-of-course
evaluation form with only numeric scores.  Lee Sharpe suggested that we
also ask students for textual comments, and the faculty approved that
amendment [9].  That form was used at the end of the semester in
Spring 1999.  The Office of Institutional Research [10] conducted a
study that suggested that the "form used in the experiment appears
to be reliable and without unreasonable biases".  Unfortunately, the
report was on the Web at 
...
is no longer available [11].  I see that the recommendation suggests that
"we are on the write track to developing a short evaluation form that
...
It looks like the proposal was presented by Elizabeth Dobbs on behalf
of Executive Council at the Faculty Meeting of November 1, 1999.
...
with overlapping confidence intervals [12].  I'm pretty sure that
...
> Concil also believes there is evidence that the quantitative data can be 
summarized in a form that will minimize the risk of invoking precise
distinctions that are not supported by the 

More importantly, the memo notes that,

> We recommend that the data be used by individual faculty members,
by the department chairs, and by the personnel committee specificaly to
...
development purposes [14].

The resolution we were called to vote upon reads as follows.
...
an ammendment to add the text _including the limits on the use of the
...
Fortunately, discussion resumed at the Faculty Meeting of December 4,
2000.  I see that there was a lot of consideration about additional,
department- or course-specific forms and what role they would serve 
in reviews.  There was also a clear effort to clarify what data
could be used.  It ended with us agreeing that one of the key
...
*only* the "numeric data" [15] should be available to Personnel.
Certainly, that's what the text suggests and what the instructions
that accompany the form say [16].

There was then further discussion about what data would be available
to the Faculty Budget Committee.  Rather than summarize the minutes,
I will simply reproduce them here.
...
That's right; even though the Budget Committee noted that they needed the
data, and Council recommended that they get those data [17], the Faculty
did not consider such uses appropriate [18].  From my perspective, we
made the right decision.  I remember, a few years later, a member of
Council making some comment on the order of "Our EOCE scores are like
Lake Wobegon; everyone is above average."  But here's the thing; it
shouldn't be surprising that we all get high "scores" on questions like
"Interactions with the faculty member helped me learn the subject matter
of the course" and "I learned a lot in the course".  Grinnell, by and
large, has very good and excellent teachers.  You would expect people
...
how to assess faculty.  I was on Council [19].  I made two suggestions:
First, that we go from a five-point to a three-value scale for teaching
[20].  Second, that Council receive the distribution of responses on
two questions ("Interactions with the faculty member helped me learn
the subject matter of the course" and "I learned a lot in this course")
as well as the comparable set of responses across similar classes (100,
200, and 300-level classes in Science, Social Studies, Foreign Language,
Arts, and the other Humanities) so that we could run statistical tests
to see if the courses were, in fact, high or low outliers.
...
writing it now, I might change the second "may" to "must".  In any case,
the faculty passed that motion.
...
can only get the text that the faculty member or their review chair chooses
to include.  THe Budget Committee can gets less; only summary info on 
...
I'm pretty sure most of the literature about bias in EOCEs has come
since 2000.  There also seems to be greater understanding that assessment
and development do not easily coexist.  And, well, the system we have
...
Postscript: Because I'm somewhat [anal retentive](anal-retentive), I went
to the College Archive to dig out the minutes of the Faculty Meetings
from the 1999-2000 End-of-Course Evaluations.  Our assistant archivist
graciously scanned them for me.  If, for some reason, you'd like a copy,
just let me know and I'll send them along.

---

[1] I use EOCE.  Almost everyone else uses EOC.  I'm not sure why they
drop the final E, since we are talking about End-of-Course *Evaluations*,
...
[9] Here we encounter the first reason that I think that every EOCE
...
[10] That office has since been renamed the Office of Analytic Support
and Institutional Research.

[11] Admittedly, I didn't try that hard.  I found [an archive of the
...
[12] Why do we have confidence intervals for categorical responses?  Because
we turn Likert-style responses (strongly agree, somewhat agree, slightly
agree, etc.) into numbers (6, 5, 4, etc.) and then average them.  I don't
consider that appropriate.  However, it appears that some statisticians
do consider this approach reasonable for Likert scales.

[14] As I've said, I'm less sure of that.

[15] I still think of Likert data as primarily qualitative, rather
...
[16] Instructors receive the completed, original froms only after
...
to include anonyous quotes in documents prepared for the faculty member's
next review.

[17] Perhaps not so surprisingly, given that the Budget Commitee is a
subset of Council.

[18] That's another reason I think that any changes to the EOCE system
need to come before the full faculty.

[19] Believe it or not, but the Science division decided they were 
willing to let me serve as Division Chair for one term.

[20] I can't recall whether I suggested 2/4/5, 1/3/5, or 1/2/3.  I'm also
not sure it maters.

---

*Version 0.9 of 2018-10-20.*
